...
public class TimeTable extends JPanel implements ActionListener {
	...
	private JComboBox[] combo;
        private ArrayList<int> idseance;
    ...
    public void AfficherSeance(Graphics g, Seance s){
        ...
        ArrayList<int> profdao = seance.getprof();
        for(int i : profdao)
        {
           ArrayList<String>  prof;
           prof.add(profdao.getName(i));
        ...
        ArrayList<int> salledao = seance.getsalle();
        for(int i : salledao)
        {
           ArrayList<String>  nomSalle;
           nomSalle.add(salledao.getName(i));
           ArrayList<int> siteSalleDao;
           siteSalleDao.add(salledao.getSite(i));
           for(int i : siteSalleDao)
           {
